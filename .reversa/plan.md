# Plano de Exploração — SandeClaw

> Criado pelo Reversa em 2026-06-16
...
- [x] ✅ **Archaeologist** — Análise do módulo `core`
- [x] ✅ **Archaeologist** — Análise do módulo `handlers`
- [x] ✅ **Archaeologist** — Análise do módulo `mcps`
- [x] ✅ **Archaeologist** — Análise do módulo `memory`
- [x] ✅ **Archaeologist** — Análise do módulo `skills`
- [x] ✅ **Archaeologist** — Análise do módulo `tools`
...
- [x] ✅ **Redator** — Módulos (`config`, `core`, `handlers`, `mcps`, `memory`, `skills`, `tools`)
- [x] ✅ **Redator** — User Stories / Fluxos
